    ...
    return (
        <>
            <Form onSubmit={handleSubmit}>
                <h2>Please Signup!</h2>
                <Form.Group>
                    <Form.Input label='Username' name='username' value={form.username} width={6} onChange={onUpdateField}/>
                    <Form.Input label='Password' type='password' name='password' width={6} value ={form.password} onChange={onUpdateField}/>
                </Form.Group>
            ...
            {isSubmitted ?
             <>
                 ...
                 <Button onClick={handleClick} content="Go to Login"/>
             </>
            : <></>}
        </>
    );
